...
const NAV_SECTIONS: NavSection[] = [
  {
    key: 'raider',
    label: 'RAIDER',
    icon: assetUrl('/main/shiestyraider.webp'),
    tabs: [
      {
        key: 'profile',
        label: 'PROFILE',
        icon: assetUrl('/main/shiesty.png'),
      },
      {
        key: 'settings',
        label: 'SYSTEM',
  ...
  },
  {
    ...
    tabs: [
      ...
      { key: 'trends', label: 'TRENDS', icon: assetUrl('/main/shiesty.png') },
      {
        key: 'enhancedstats',
        label: 'ADVANCED',
        icon: assetUrl('/main/king.webp'),
      },
      {
        key: 'performance',
        label: 'PERFORMANCE',
        icon: assetUrl('/main/aggressive.webp'),
      },
      {
        key: 'trials',
        label: 'TRIALS',
  ...
  },
  {
    key: 'stash',
    label: 'STASH',
    icon: assetUrl('/main/backpack.webp'),
    tabs: [
      { key: 'stash', label: 'STASH', icon: assetUrl('/main/backpack.webp') },
      {
        key: 'items',
        label: 'ITEMS',
        icon: assetUrl('/main/valuableicon.webp'),
      },
      {
        key: 'blueprints',
        label: 'BLUEPRINTS',
      ...
      },
      {
        key: 'loadout',
        label: 'LOADOUT',
        icon: assetUrl('/main/weapon.webp'),
      },
    ],
  },
  {
    key: 'world',
    label: 'WORLD',
    icon: assetUrl('/main/raidertool.webp'),
    tabs: [
      { key: 'mapviewer', label: 'MAP', icon: assetUrl('/main/shiesty.png') },
      { key: 'maps', label: 'RAIDS', icon: assetUrl('/main/embark.webp') },
      {
        key: 'eventtimers',
        label: 'EVENTS',
        icon: assetUrl('/main/shiestyraider.webp'),
...
export default function Header({
  ...
  const level = pickNumber(stats?.gameLevel, stats?.level, stats?.playerLevel);
  ...
  const embarkUsername =
    ...
    (profile as any)?.embarkUsername ||
    null;
  const embarkDisplayName = embarkUsername || 'SHiESTY#****';
          ...
          <div className="flex items-center gap-3 flex-nowrap">
            ...
            {profile ? (
                ...
                {hasStats && (
                  ...
                  >
                    <HeaderStatChip
                      ...
                      title={
                        expeditionStatus
                          ? `Season ${expeditionStatus.activeSeason} · ${expeditionStatus.state}`
                          : 'Expedition status'
                      }
                    />
                    <HeaderStatChip
                    ...
                    >
                      <img
                        src={assetUrl('/main/raider_token24.webp')}
                        alt="Tokens"
                        className="w-4 h-4 object-contain"
                      />
                      <span
              ...
              <div className="flex items-center gap-2">
                ...
                >
                  <span className="hidden sm:inline">SHIESTY IN</span>
