...
export const RARITY_BG: Record<string, string> = {
  Legendary: assetUrl('/raritybg/legendary_bg.webp'),
  Epic: assetUrl('/raritybg/epic_bg.png'),
  Rare: assetUrl('/raritybg/rare_bg.png'),
  Uncommon: assetUrl('/raritybg/uncommon_bg.png'),
  Common: assetUrl('/raritybg/common_bg.png'),
