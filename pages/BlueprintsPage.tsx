  ...
  return (
    ...
    >
      ...
      >
        <button
          onClick={onClose}
          className="absolute top-3 right-3 text-[var(--color-arc-legendary)] hover:text-white"
        >
          <X className="w-4 h-4" />
        </button>
          ...
          <div className="flex gap-2 shrink-0 flex-wrap justify-end">
            ...
            >
              <button
                ...
                disabled={!!exporting}
                className="flex items-center gap-1.5 px-3 py-2 text-xs font-black uppercase tracking-widest border border-[#1e1e2e] text-[var(--color-arc-muted)] hover:border-[var(--color-arc-uncommon)] hover:text-[var(--color-arc-uncommon)] transition-colors disabled:opacity-40"
              >
            ...
            >
              <button
                ...
                disabled={!!exporting}
                className="flex items-center gap-1.5 px-3 py-2 text-xs font-black uppercase tracking-widest border border-[#1e1e2e] text-[var(--color-arc-muted)] hover:border-[var(--color-arc-yellow)] hover:text-arc-yellow transition-colors disabled:opacity-40"
              >
                {exporting === 'img' ? (
