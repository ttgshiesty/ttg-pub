                    ...
                    return (
                      ...
                      >
                        ...
                        >
                          ...
                          {/* Item image */}
                          <div
                            className="aspect-square border border-[#1a1120] mb-2 flex items-center justify-center overflow-hidden"
                            style={{
                              background: '#050505',
                              backgroundImage:
            ...
            {(() => {
              ...
              return (
                <>
                  ...
                  <div className="aspect-video bg-[#050505] border border-[#1a1120] mb-4 flex items-center justify-center">
                    {localUrl ? (
                      <img
                        src={localUrl}
                        alt={name}
